...
# --- LAS 3 RUTAS DE GALERÍAS (NOMBRES LIMPIOS) ---

@app.route('/farmaceuticas')
def farma():
    # Busca 15 fotos: farma1.jpeg hasta farma15.jpeg
...
def alimen():
    # Busca 15 fotos: alimen1.jpeg hasta alimen15.jpeg
...
@app.route('/naval')
def naval():
    # Busca 55 fotos: naval1.jpeg hasta naval55.jpeg
